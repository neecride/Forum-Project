                            ...
                            do {
                                ...
                                if (c) {
                                    ...
                                    if (l !== d || isNaN(f)) {
                                        ...
                                        o += 1;
                                    } else h === f && (p = f + 1), h > f && (p = h + 1), e.replaceRange(u.replace(t, d + p + c[4] + c[5]), { line: s, ch: 0 }, { line: s, ch: u.length });
                                }
                            } while (c);
                        }
                        ...
                        e.overlayMode = function (t, n, i) {
                            return {
                                ...
                                copyState: function (i) {
                                    return { base: e.copyState(t, i.base), overlay: e.copyState(n, i.overlay), basePos: i.basePos, baseCur: null, overlayPos: i.overlayPos, overlayCur: null };
                                },
                                token: function (e, r) {
                                    return (
                                        (e != r.streamSeen || Math.min(r.basePos, r.overlayPos) < e.start) && ((r.streamSeen = e), (r.basePos = r.overlayPos = e.start)),
                    ...
                    (function (e) {
                        ...
                        function l(e, t, n) {
                            ...
                            for (var l, s = 1, u = n.line, c = e.lastLine(); u <= c; ) {
                                ...
                                if (f) {
                                    ...
                                    return { from: i(g, v), to: i(g + m.length - 1, 1 == m.length ? v + m[0].length : m[m.length - 1].length), match: f };
                                }
                            }
                        }
                        function s(e, t, n) {
                        ...
                        function h(e, r, o, a) {
                            ...
                            e: for (var u = o.line, c = o.ch, h = e.lastLine() + 1 - s.length; u <= h; u++, c = 0) {
                                ...
                                if (1 == s.length) {
                                    var m = p.indexOf(s[0]);
                                    if (-1 == m) continue e;
                                    return (o = d(f, p, m, l) + c), { from: i(u, d(f, p, m, l) + c), to: i(u, d(f, p, m + s[0].length, l) + c) };
                                }
                                var g = p.length - s[0].length;
                                if (p.slice(g) == s[0]) {
                                    for (var v = 1; v < s.length - 1; v++) if (l(e.getLine(u + v)) != s[v]) continue e;
                                    var x = e.getLine(u + s.length - 1),
                                        y = l(x),
                                        b = s[s.length - 1];
                                    if (y.slice(0, b.length) == b) return { from: i(u, d(f, p, g, l) + c), to: i(u + s.length - 1, d(x, y, b.length, l)) };
                                }
                            }
                        }
                        function f(e, r, o, a) {
                            ...
                            e: for (var u = o.line, c = o.ch, h = e.firstLine() - 1 + s.length; u >= h; u--, c = -1) {
                                ...
                                if (p.slice(0, g.length) == g) {
                                    var v = 1;
                                    for (o = u - s.length + 1; v < s.length - 1; v++) if (l(e.getLine(o + v)) != s[v]) continue e;
                                    var x = e.getLine(u + 1 - s.length),
                                        y = l(x);
                                    if (y.slice(y.length - s[0].length) == s[0]) return { from: i(u + 1 - s.length, d(x, y, x.length - s[0].length, l)), to: i(u, d(f, p, g.length, l)) };
                                }
                            }
                        }
                        function p(e, t, n, o) {
                        ...
                        String.prototype.normalize
                            ...
                            (p.prototype = {
                                ...
                                find: function (t) {
                                    ...
                                    if (
                                        ...
                                        this.atOccurrence &&
                                        ((n = i(n.line, n.ch)),
                                        t ? (n.ch--, n.ch < 0 && (n.line--, (n.ch = (this.doc.getLine(n.line) || "").length))) : (n.ch++, n.ch > (this.doc.getLine(n.line) || "").length && ((n.ch = 0), n.line++)),
                            ...
                            e.defineExtension("selectMatches", function (t, n) {
                                for (var i = [], r = this.getSearchCursor(t, this.getCursor("from"), n); r.findNext() && !(e.cmpPos(r.to(), this.getCursor("to")) > 0); ) i.push({ anchor: r.from(), head: r.to() });
                ...
                function (e, t, n) {
                    (function (e) {
                        ...
                        e.defineOption("styleSelectedText", !1, function (i, r, o) {
                            var s = o && o != e.Init;
                            r && !s
                                ? ((i.state.markedSelection = []), (i.state.markedSelectionStyle = "string" == typeof r ? r : "CodeMirror-selectedtext"), l(i), i.on("cursorActivity", t), i.on("change", n))
                                : !r && s && (i.off("cursorActivity", t), i.off("change", n), a(i), (i.state.markedSelection = i.state.markedSelectionStyle = null));
                        });
                        var i = e.Pos,
                            r = e.cmpPos;
                        function o(e, t, n, o) {
                    ...
                    !(function (e, i) {
                        ...
                        var de = (function () {
                            ...
                            return function (a, l) {
                                ...
                                return (
                                    "ltr" == l &&
                                        (1 == z[0].level && (I = a.match(/^\s+/)) && ((z[0].from = I[0].length), z.unshift(new o(0, 0, I[0].length))),
                                        1 == Y(z).level && (I = a.match(/\s+$/)) && ((Y(z).to -= I[0].length), z.push(new o(0, c - I[0].length, c)))),
                                    "rtl" == l ? z.reverse() : z
                                );
                            };
                        })();
                        ...
                        function ye(e) {
                            ...
                            if (t) for (var n = e.curOp.cursorActivityHandlers || (e.curOp.cursorActivityHandlers = []), i = 0; i < t.length; ++i) -1 == q(n, t[i]) && n.push(t[i]);
                        }
                        function be(e, t) {
                        ...
                        function Je(e) {
                            ...
                            for (var t = e.parent, n = q(t.lines, e), i = t.parent; i; t = i, i = i.parent) for (var r = 0; i.children[r] != t; ++r) n += i.children[r].chunkSize();
                            return n + t.first;
                        }
                        function et(e, t) {
                            var n = e.first;
                        ...
                        (Xe.prototype.eol = function () {
                            ...
                            (Xe.prototype.column = function () {
                                return (
                                    this.lastColumnPos < this.start && ((this.lastColumnValue = W(this.string, this.start, this.tabSize, this.lastColumnPos, this.lastColumnValue)), (this.lastColumnPos = this.start)),
                        ...
                        function Dt(e, t, n, i) {
                            ...
                            for (i && (o = []); (i || c.pos < t.ch) && !c.eol(); ) (c.start = c.pos), (r = yt(l, c, u.state)), i && o.push(new bt(c, r, $e(a.mode, u.state)));
                        ...
                        function Lt(e, t) {
                            ...
                            if (!u) {
                                var v,
                                    x = t.text.length - 2;
                                if (x > 0 && l) for (var y = 0; y < l.length; ++y) null == l[y].to && (v || (v = [])).push(new Ft(l[y].marker, null, null));
                        ...
                        function zt(e, t) {
                            var n,
                                i = St && e.markedSpans;
                            if (i) for (var r = void 0, o = 0; o < i.length; ++o) (r = i[o]).marker.collapsed && null == (t ? r.from : r.to) && (!n || It(n, r.marker) < 0) && (n = r.marker);
                            return n;
                        }
                        function Ht(e) {
                            return zt(e, !0);
                            ...
                            if (a)
                                for (var l = 0; l < a.length; ++l) {
                                    ...
                                    if (s.marker.collapsed) {
                                        ...
                                        if (
                                            !((c >= 0 && d <= 0) || (c <= 0 && d >= 0)) &&
                                            ((c <= 0 && (s.marker.inclusiveRight && r.inclusiveLeft ? rt(u.to, n) >= 0 : rt(u.to, n) > 0)) || (c >= 0 && (s.marker.inclusiveRight && r.inclusiveLeft ? rt(u.from, i) <= 0 : rt(u.from, i) < 0)))
                                        )
                                            return !0;
                                    }
                                }
                        ...
                        function en(e, t) {
                            var n = M("span", null, null, s ? "padding-right: .1px" : null),
                                i = { pre: M("pre", [n], "CodeMirror-line"), content: n, col: 0, pos: 0, cm: e, trailingSpace: !1, splitSpaces: e.getOption("lineWrapping") };
                            t.measure = {};
                            for (var r = 0; r <= (t.rest ? t.rest.length : 0); r++) {
                                ...
                                (i.pos = 0),
                                    ...
                                    o.styleClasses && (o.styleClasses.bgClass && (i.bgClass = I(o.styleClasses.bgClass, i.bgClass || "")), o.styleClasses.textClass && (i.textClass = I(o.styleClasses.textClass, i.textClass || ""))),
                        ...
                        function nn(e, t, n, i, r, o, s) {
                            if (t) {
                                ...
                                if (d.test(t)) {
                                    ...
                                    for (var f = 0; ; ) {
                                        ...
                                        if ("\t" == p[0]) {
                                            ...
                                            "\r" == p[0] || "\n" == p[0]
                                                ? ((v = u.appendChild(T("span", "\r" == p[0] ? "␍" : "␤", "cm-invalidchar"))).setAttribute("cm-text", p[0]), (e.col += 1))
                                                : ((v = e.cm.options.specialCharPlaceholder(p[0])).setAttribute("cm-text", p[0]), a && l < 9 ? u.appendChild(T("span", [v])) : u.appendChild(v), (e.col += 1));
                                ...
                                if (((e.trailingSpace = 32 == c.charCodeAt(t.length - 1)), n || i || r || h || o || s)) {
                                    ...
                                    i && (b += i), r && (b += r);
                                    var D = T("span", [u], b, o);
                                    if (s) for (var C in s) s.hasOwnProperty(C) && "style" != C && "class" != C && D.setAttribute(C, s[C]);
                        ...
                        function an(e, t, n) {
                            ...
                            else for (var L = 1; L < n.length; L += 2) t.addToken(t, r.slice(o, (o = n[L])), Jt(n[L + 1], t.cm.options));
                        }
                        function ln(e, t, n) {
                            (this.line = t),
                        ...
                        function pn(e) {
                            return (
                                e.node == e.text &&
                                    ((e.node = T("div", null, null, "position: relative")), e.text.parentNode && e.text.parentNode.replaceChild(e.node, e.text), e.node.appendChild(e.text), a && l < 8 && (e.node.style.zIndex = 2)),
                                e.node
                            );
                        }
                        function mn(e, t) {
                        ...
                        function gn(e, t) {
                            ...
                            t.text == t.node && (t.node = i.pre),
                                ...
                                (t.text = i.pre),
                                i.bgClass != t.bgClass || i.textClass != t.textClass ? ((t.bgClass = i.bgClass), (t.textClass = i.textClass), vn(e, t)) : n && (t.text.className = n);
                        }
                        function vn(e, t) {
                            !(function (e, t) {
                                ...
                                if (
                                    ...
                                    !e.options.lineNumbers ||
                                        ...
                                        (t.lineNumber = l.appendChild(
                                            T("div", nt(e.options, n), "CodeMirror-linenumber CodeMirror-gutter-elt", "left: " + i.gutterLeft["CodeMirror-linenumbers"] + "px; width: " + e.display.lineNumInnerWidth + "px")
                                        )),
                                    o)
                                )
                        ...
                        function Dn(e, t, n) {
                            if ((Cn(e, t.line, t, n, !0), t.rest)) for (var i = 0; i < t.rest.length; i++) Cn(e, t.rest[i], t, n, !1);
                        }
                        ...
                        function Sn(e, t) {
                            for (var n = Fe(t); n != e.wrapper; n = n.parentNode) if (!n || (1 == n.nodeType && "true" == n.getAttribute("cm-ignore-events")) || (n.parentNode == e.sizer && n != e.mover)) return !0;
                        }
                        function Fn(e) {
                        ...
                        function Bn(e, t, n) {
                            ...
                            if (e.rest) {
                                for (var i = 0; i < e.rest.length; i++) if (e.rest[i] == t) return { map: e.measure.maps[i], cache: e.measure.caches[i] };
                                for (var r = 0; r < e.rest.length; r++) if (Je(e.rest[r]) > n) return { map: e.measure.maps[r], cache: e.measure.caches[r], before: !0 };
                            }
                        }
                        function Nn(e, t, n, i) {
                        ...
                        function In(e, t) {
                            var n = Je(t),
                                i = On(e, n);
                            i && !i.text ? (i = null) : i && i.changes && (fn(e, i, n, si(e)), (e.curOp.forceUpdate = !0)),
                                i ||
                                    (i = (function (e, t) {
                                        var n = Je((t = Wt(t))),
                                    ...
                                    : (t.rect || (t.rect = t.view.text.getBoundingClientRect()),
                                      ...
                                      (o = (function (e, t, n, i) {
                                          ...
                                          if (a && l < 9 && !u && (!r || (!r.left && !r.right))) {
                                              ...
                                              r = p ? { left: p.left, right: p.left + li(e.display), top: p.top, bottom: p.bottom } : Rn;
                                          }
                                          for (var m = r.top - t.rect.top, g = r.bottom - t.rect.top, v = (m + g) / 2, x = t.view.measure.heights, y = 0; y < x.length - 1 && !(v < x[y]); y++);
                                          var b = y ? x[y - 1] : 0,
                                              D = x[y],
                                              C = { left: ("right" == d ? r.right : r.left) - t.rect.left, right: ("left" == d ? r.left : r.right) - t.rect.left, top: b, bottom: D };
                        ...
                        function Pn(e, t, n) {
                            for (var i, r, o, a, l, s, u = 0; u < e.length; u += 3)
                                if (
                                    ((l = e[u]),
                                    (s = e[u + 1]),
                                    t < l ? ((r = 0), (o = 1), (a = "left")) : t < s ? (o = (r = t - l) + 1) : (u == e.length - 3 || (t == s && e[u + 3] > t)) && ((r = (o = s - l) - 1), t >= s && (a = "right")),
                                    null != r)
                                ) {
                                    if (((i = e[u + 2]), l == s && n == (i.insertLeft ? "left" : "right") && (a = n), "left" == n && 0 == r)) for (; u && e[u - 2] == e[u - 3] && e[u - 1].insertLeft; ) (i = e[2 + (u -= 3)]), (a = "left");
                                    if ("right" == n && r == s - l) for (; u < e.length - 3 && e[u + 3] == e[u + 4] && !e[u + 5].insertLeft; ) (i = e[(u += 3) + 2]), (a = "right");
                                    break;
                                }
                        ...
                        function oi(e, t, n, i, r, o, a) {
                            ...
                            return c || (c = r[r.length - 1]), c.from < s && (c = { from: s, to: c.to, level: c.level }), c.to > u && (c = { from: c.from, to: u, level: c.level }), c;
                        }
                        function ai(e) {
                        ...
                        function si(e) {
                            ...
                            return { fixedPos: ui(t), gutterTotalWidth: t.gutters.offsetWidth, gutterLeft: n, gutterWidth: i, wrapperWidth: t.wrapper.clientWidth };
                        }
                        function ui(e) {
                                ...
                                return (
                                    (function (e, t, n, i) {
                                        ...
                                        if (x.top - v.top <= 3) {
                                            ...
                                            var F, A, E, L;
                                            g
                                                ? ((F = u && y && D ? l : v.left), (A = u ? s : p(e, r, "before")), (E = u ? l : p(t, r, "after")), (L = u && b && C ? s : x.right))
                                                : ((F = u ? p(e, r, "before") : l), (A = !u && y && D ? s : v.right), (E = !u && b && C ? l : x.left), (L = u ? p(t, r, "after") : s)),
                        ...
                        function Ei(e, t) {
                            e.state.delayingBlurEvent ||
                                (e.state.focused && (ve(e, "blur", e, t), (e.state.focused = !1), A(e.display.wrapper, "CodeMirror-focused")),
                        ...
                        function Li(e) {
                            for (var t = e.display, n = t.lineDiv.offsetTop, i = Math.max(0, t.scroller.getBoundingClientRect().top), r = t.lineDiv.getBoundingClientRect().top, o = 0, s = 0; s < t.view.length; s++) {
                                ...
                                if (!u.hidden) {
                                    ...
                                    if ((m > 0.005 || m < -0.005) && (r < i && (o -= m), Qe(u.line, d), Ti(u.line), u.rest)) for (var g = 0; g < u.rest.length; g++) Ti(u.rest[g]);
                        ...
                        function Hi(e, t, n, i) {
                            var r = Bi(e, { left: Math.min(t.left, n.left), top: Math.min(t.top, n.top) - i, right: Math.max(t.right, n.right), bottom: Math.max(t.bottom, n.bottom) + i });
                            Ii(e, r.scrollLeft, r.scrollTop);
                        }
                        function Ri(e, t) {
                            Math.abs(e.doc.scrollTop - t) < 2 || (n || hr(e, { top: t }), Pi(e, t, !0), n && hr(e), ar(e, 100));
                        }
                        function Pi(e, t, n) {
                        ...
                        function _i(e, t, n, i) {
                            (t = Math.max(0, Math.min(t, e.display.scroller.scrollWidth - e.display.scroller.clientWidth))),
                                ((n ? t == e.doc.scrollLeft : Math.abs(e.doc.scrollLeft - t) < 2) && !i) ||
                                    ((e.doc.scrollLeft = t), mr(e), e.display.scroller.scrollLeft != t && (e.display.scroller.scrollLeft = t), e.display.scrollbars.setScrollLeft(t));
                        }
                        function Wi(e) {
                            var t = e.display,
                        ...
                        (ji.prototype.update = function (e) {
                            ...
                            return !this.checkedZeroWidth && e.clientHeight > 0 && (0 == i && this.zeroWidthHack(), (this.checkedZeroWidth = !0)), { right: n ? i : 0, bottom: t ? i : 0 };
                        }),
                        ...
                        function $i(e, t) {
                            ...
                            (n.sizer.style.paddingRight = (n.barWidth = i.right) + "px"),
                                ...
                                i.right && i.bottom
                                    ? ((n.scrollbarFiller.style.display = "block"), (n.scrollbarFiller.style.height = i.bottom + "px"), (n.scrollbarFiller.style.width = i.right + "px"))
                                    : (n.scrollbarFiller.style.display = ""),
                                i.bottom && e.options.coverGutterNextToScrollbar && e.options.fixedGutter
                                    ? ((n.gutterFiller.style.display = "block"), (n.gutterFiller.style.height = i.bottom + "px"), (n.gutterFiller.style.width = t.gutterWidth + "px"))
                        ...
                        function Vi(e) {
                            e.display.scrollbars && (e.display.scrollbars.clear(), e.display.scrollbars.addClass && A(e.display.wrapper, e.display.scrollbars.addClass)),
                        ...
                        function Yi(e) {
                            ...
                            !(function (e) {
                                ...
                                (e.update = e.mustUpdate && new sr(t, e.mustUpdate && { top: e.scrollTop, ensure: e.scrollToPos }, e.forceUpdate));
                        }
                        function Qi(e) {
                        ...
                        function er(e) {
                            ...
                            null != e.adjustWidthTo &&
                                ((t.display.sizer.style.minWidth = e.adjustWidthTo + "px"), e.maxScrollLeft < t.doc.scrollLeft && _i(t, Math.min(t.display.scroller.scrollLeft, e.maxScrollLeft), !0), (t.display.maxLineChanged = !1));
                                ...
                                var r = (function (e, t, n, i) {
                                    ...
                                    for (var o = 0; o < 5; o++) {
                                        var a = !1,
                                            l = Zn(e, t),
                                            s = n && n != t ? Zn(e, n) : l,
                                            u = Bi(e, (r = { left: Math.min(l.left, s.left), top: Math.min(l.top, s.top) - i, right: Math.max(l.left, s.left), bottom: Math.max(l.bottom, s.bottom) + i })),
                                            c = e.doc.scrollTop,
                                            d = e.doc.scrollLeft;
                                        if ((null != u.scrollTop && (Ri(e, u.scrollTop), Math.abs(e.doc.scrollTop - c) > 1 && (a = !0)), null != u.scrollLeft && (_i(e, u.scrollLeft), Math.abs(e.doc.scrollLeft - d) > 1 && (a = !0)), !a))
                                            break;
                                    }
                                    return r;
                        ...
                        function cr(e, t) {
                            ...
                            !(function (e, t, n) {
                                ...
                                0 == i.view.length || t >= i.viewTo || n <= i.viewFrom
                                    ...
                                    : (i.viewFrom > t ? (i.view = sn(e, t, i.viewFrom).concat(i.view)) : i.viewFrom < t && (i.view = i.view.slice(fi(e, t))),
                                      (i.viewFrom = t),
                            ...
                            return (
                                ...
                                (function (e) {
                                    if (
                                        ...
                                        (e.activeElt.focus(), !/^(INPUT|TEXTAREA)$/.test(e.activeElt.nodeName) && e.anchorNode && B(document.body, e.anchorNode) && B(document.body, e.focusNode))
                                    ) {
                                ...
                                l && ((n.lastWrapHeight = t.wrapperHeight), (n.lastWrapWidth = t.wrapperWidth), ar(e, 400)),
                        ...
                        function dr(e, t) {
                            for (var n = t.viewport, i = !0; ; i = !1) {
                                if (i && e.options.lineWrapping && t.oldDisplayWidth != Tn(e)) i && (t.visible = Mi(e.display, e.doc, n));
                                    ...
                                    (n && null != n.top && (n = { top: Math.min(e.doc.height + An(e.display) - Mn(e), n.top) }),
                        ...
                        function Sr(e, t) {
                            ...
                            if ((r && f) || (o && p)) {
                                ...
                                if (o && null != a) {
                                    ...
                                    x < 0 ? (b = Math.max(0, b + x - 50)) : (D = Math.min(e.doc.height, D + x + 50)), hr(e, { top: b, bottom: D });
                                }
                                Dr < 20 &&
                                    0 !== t.deltaMode &&
                                    (null == l.wheelStartX
                        ...
                        function Ur(e, t, n, i) {
                            ...
                            var o,
                                ...
                                l = +new Date();
                            if (
                                (r.lastOp == i || (r.lastOrigin == t.origin && t.origin && (("+" == t.origin.charAt(0) && r.lastModTime > l - (e.cm ? e.cm.options.historyEventDelay : 500)) || "*" == t.origin.charAt(0)))) &&
                                (o = (function (e, t) {
                                ...
                                (a = Y(o.changes)), 0 == rt(t.from, t.to) && 0 == rt(t.from, a.to) ? (a.to = Tr(t)) : o.changes.push(jr(e, t));
                            else {
                                var s = Y(r.done);
                                for ((s && s.ranges) || Gr(e.sel, r.done), o = { changes: [jr(e, t)], generation: r.generation }, r.done.push(o); r.done.length > r.undoDepth; ) r.done.shift(), r.done[0].ranges || r.done.shift();
                            }
                            ...
                            (o &&
                                ...
                                ((r.lastModTime == r.lastSelTime && r.lastOrigin == o) ||
                                    (function (e, t, n, i) {
                                        ...
                                        return (
                                            "*" == r ||
                                            ("+" == r && n.ranges.length == i.ranges.length && n.somethingSelected() == i.somethingSelected() && new Date() - e.history.lastSelTime <= (e.cm ? e.cm.options.historyEventDelay : 500))
                                        );
                                    })(e, o, Y(r.done), t)))
                            ...
                            for (var i = [], r = 0; r < e.length; ++r) {
                                ...
                                if (o.ranges) i.push(n ? Fr.prototype.deepCopy.call(o) : o);
                                    ...
                                    for (var s = 0; s < a.length; ++s) {
                                        var u = a[s],
                                            c = void 0;
                                        if ((l.push({ from: u.from, to: u.to, text: u.text }), t)) for (var d in u) (c = d.match(/^spans_(\d+)$/)) && q(t, Number(c[1])) > -1 && ((Y(l)[d] = u[d]), delete u[d]);
                                    }
                                }
                            }
                            return i;
                        ...
                        function fo(e, t, n) {
                            ...
                            return (
                                ...
                                i.canceled ? (e.cm && (e.cm.curOp.updateInput = 2), null) : { from: i.from, to: i.to, text: i.text, origin: i.origin }
                            );
                        }
                        function po(e, t, n) {
                            if (e.cm) {
                            ...
                            if (!(be(e, "beforeChange") || (e.cm && be(e.cm, "beforeChange"))) || (t = fo(e, t, !0))) {
                                            ...
                                            for (var a = i[o], l = a.find(0), s = 0; s < r.length; ++s) {
                                                ...
                                                if (!(rt(u.to, l.from) < 0 || rt(u.from, l.to) > 0)) {
                                                    var c = [s, 1],
                                                        d = rt(u.from, l.from),
                                                        h = rt(u.to, l.to);
                                                    (d < 0 || (!a.inclusiveLeft && !d)) && c.push({ from: u.from, to: l.from }),
                                                        (h > 0 || (!a.inclusiveRight && !h)) && c.push({ from: l.to, to: u.to }),
                                                        r.splice.apply(r, c),
                                                        (s += c.length - 3);
                                                }
                                            }
                                ...
                                if (i) for (var r = i.length - 1; r >= 0; --r) mo(e, { from: i[r].from, to: i[r].to, text: r ? [""] : t.text, origin: t.origin });
                                else mo(e, t);
                            }
                        }
                        function mo(e, t) {
                        ...
                        function go(e, t, n) {
                            ...
                            if (!i || n) {
                                ...
                                if (u != l.length) {
                                    ...
                                    var c = [];
                                    Gr(a, s), s.push({ changes: c, generation: o.generation }), (o.generation = r.generation || ++o.maxGeneration);
                                    for (
                                        var d = be(e, "beforeChange") || (e.cm && be(e.cm, "beforeChange")),
                                            h = function (n) {
                                                ...
                                                c.push(jr(e, i));
                                                var o = n ? Br(e, i) : Y(l);
                                                xo(e, i, o, Kr(e, i)), !n && e.cm && e.cm.scrollIntoView({ from: i.from, to: Tr(i) });
                                                var a = [];
                                                Rr(e, function (e, t) {
                        ...
                        function xo(e, t, n, i) {
                            ...
                            if (t.to.line < e.first) vo(e, t.text.length - 1 - (t.to.line - t.from.line));
                                ...
                                if (t.from.line < e.first) {
                                    ...
                                    vo(e, r), (t = { from: it(e.first, 0), to: it(t.to.line + r, t.to.ch), text: [Y(t.text)], origin: t.origin });
                                }
                                var o = e.lastLine();
                                t.to.line > o && (t = { from: t.from, to: it(o, Ke(e, o).text.length), text: [t.text[0]], origin: t.origin }),
                        ...
                        function yo(e, t, n, i, r) {
                            var o;
                            i || (i = n), rt(i, n) < 0 && ((n = (o = [i, n])[0]), (i = o[1])), "string" == typeof t && (t = e.splitLines(t)), po(e, { from: n, to: i, text: t, origin: r });
                        }
                        function bo(e, t, n, i) {
                        ...
                        function To(e, t, n, i, r) {
                            ...
                            if (
                                ...
                                o.readOnly && ((kt = !0), (e.history.done.length || e.history.undone.length) && e.clearHistory()),
                                o.collapsed && ((o.id = ++Eo), (o.atomic = !0)),
                                u)
                            ) {
                                if ((l && (u.curOp.updateMaxLine = !0), o.collapsed)) pi(u, t.line, n.line + 1);
                                else if (o.className || o.startStyle || o.endStyle || o.css || o.attributes || o.title) for (var c = t.line; c <= n.line; c++) mi(u, c, "text");
                        ...
                        (Lo.prototype.clear = function () {
                            if (!this.explicitlyCleared) {
                                ...
                                for (var i = null, r = null, o = 0; o < this.lines.length; ++o) {
                                    ...
                                    e && !this.collapsed ? mi(e, Je(a), "text") : e && (null != l.to && (r = Je(a)), null != l.from && (i = Je(a))),
                        ...
                        (Io.prototype = ee(So.prototype, {
                            ...
                            setValue: or(function (e) {
                                ...
                                po(this, { from: t, to: it(n, Ke(this, n).text.length), text: this.splitLines(e), origin: "setValue", full: !0 }, !0), this.cm && Ii(this.cm, 0, 0), io(this, Lr(t), $);
                            }),
                                ...
                                if (n && !t.isReadOnly())
                                    if (i && i.length && window.FileReader && window.File)
                                        ...
                                        try {
                                            ...
                                            if (d) {
                                                var h;
                                                if ((t.state.draggingText && !t.state.draggingText.copy && (h = t.listSelections()), ro(t.doc, Lr(n, n)), h)) for (var f = 0; f < h.length; ++f) yo(t.doc, "", h[f].anchor, h[f].head, "drag");
                            ...
                            killLine: function (e) {
                                return ta(e, function (t) {
                                    if (t.empty()) {
                                        ...
                                        return t.head.ch == n && t.head.line < e.lastLine() ? { from: t.head, to: it(t.head.line + 1, 0) } : { from: t.head, to: it(t.head.line, n) };
                                    }
                                        ...
                                        if (t[i].empty()) {
                                            ...
                                            if (o)
                                                if ((r.ch == o.length && (r = new it(r.line, r.ch - 1)), r.ch > 0))
                                                    (r = new it(r.line, r.ch + 1)), e.replaceRange(o.charAt(r.ch - 1) + o.charAt(r.ch - 2), it(r.line, r.ch - 2), r, "+transpose");
                        ...
                        function pa(e) {
                            ...
                            if (!((e.target && e.target != t.display.input.getField()) || ((t.curOp.focus = N(H(t))), xe(t, e)))) {
                                ...
                                var r = ha(t, e);
                                h && ((fa = r ? i : null), r || 88 != i || ze || !(y ? e.metaKey : e.ctrlKey) || t.replaceSelection("", null, "cut")),
                                                ...
                                                ? i
                                                    ? (function (e, t, n, i) {
                                                          ...
                                                          var r,
                                                              ...
                                                              u = e.doc.sel;
                                                          e.options.dragDrop && Te && !e.isReadOnly() && "single" == n && (r = u.contains(t)) > -1 && (rt((r = u.ranges[r]).from(), t) < 0 || t.xRel > 0) && (rt(r.to(), t) > 0 || t.xRel < 0)
                                                              ? (function (e, t, n, i) {
                                                                    var r = e.display,
                                                                        o = !1,
                                                                        u = ir(e, function (t) {
                                                              ...
                                                              : (function (e, t, n, i) {
                                                                    ...
                                                                    i.addNew
                                                                        ? -1 == s
                                                                            ? ((s = c.length), io(o, Er(e, c.concat([l]), s), { scroll: !1, origin: "*mouse" }))
                                                                            : c.length > 1 && c[s].empty() && "char" == i.unit && !i.extend
                                                                            ? (io(o, Er(e, c.slice(0, s).concat(c.slice(s + 1)), 0), { scroll: !1, origin: "*mouse" }), (u = o.sel))
                                                                            : eo(o, s, l, G)
                                                                    ...
                                                                    function f(t) {
                                                                        if (0 != rt(h, t))
                                                                            if (((h = t), "rectangle" == i.unit)) {
                                                                                ...
                                                                                r.length || r.push(new Ar(n, n)), io(o, Er(e, u.ranges.slice(0, s).concat(r), s), { origin: "*mouse", scroll: !1 }), e.scrollIntoView(t);
                                                                            } else {
                                                                                var y,
                                                                                    b = l,
                                                                                    D = Da(e, t, i.unit),
                        ...
                        function Ta(e) {
                            e.options.lineWrapping ? (O(e.display.wrapper, "CodeMirror-wrap"), (e.display.sizer.style.minWidth = ""), (e.display.sizerWidth = null)) : (A(e.display.wrapper, "CodeMirror-wrap"), Xt(e)),
                                di(e),
                                pi(e),
                                qn(e),
                                setTimeout(function () {
                            ...
                            (function (e) {
                                ...
                                pe(t.scroller, "touchstart", function (r) {
                                    if (!xe(e, r) && !o(r) && !wa(e, r)) {
                                        ...
                                        var a = +new Date();
                                        (t.activeTouch = { start: a, moved: !1, prev: a - i.end <= 300 ? i : null }), 1 == r.touches.length && ((t.activeTouch.left = r.touches[0].pageX), (t.activeTouch.top = r.touches[0].pageY));
                                    }
                                }),
                                                    ...
                                                    if (n) {
                                                        ...
                                                        Di(e, n, i),
                                                            e.display.dragCursor ||
                                                                ((e.display.dragCursor = T("div", null, "CodeMirror-cursors CodeMirror-dragcursors")), e.display.lineSpace.insertBefore(e.display.dragCursor, e.display.cursorDiv)),
                            ...
                            for (var d = e.curOp.updateInput, h = i.ranges.length - 1; h >= 0; h--) {
                                ...
                                f.empty() &&
                                    (n && n > 0
                                        ...
                                        : l && Oa && Oa.lineWise && Oa.text.join("\n") == s.join("\n") && (p = m = it(p.line, 0)));
                                var g = { from: p, to: m, text: u ? u[h % u.length] : s, origin: r || (l ? "paste" : e.state.cutIncoming > a ? "cut" : "+input") };
                                    ...
                                    a = r
                                        ? (function (e, t, n, i) {
                                              ...
                                              var l,
                                                  ...
                                                  u = function (n) {
                                                      return e.options.lineWrapping ? ((l = l || In(e, t)), ti(e, t, l, n)) : { begin: 0, end: t.text.length };
                                                  },
                        ...
                        (Ua.prototype.init = function (e) {
                            ...
                            function a(e) {
                                if (o(e) && !xe(i, e)) {
                                    if (i.somethingSelected()) Ia({ lineWise: !1, text: i.getSelections() }), "cut" == e.type && i.replaceSelection("", null, "cut");
                                    else {
                                ...
                                if (t.display.viewTo == t.display.viewFrom || r.line >= t.display.viewTo || o.line < t.display.viewFrom) e.removeAllRanges();
                                    ...
                                    if (!a || a.bad || !l || l.bad || 0 != rt(st(a, l), r) || 0 != rt(lt(a, l), o)) {
                                        var s = t.display.view,
                                            u = (r.line >= t.display.viewFrom && $a(t, r)) || { node: s[0].measure.map[2], offset: 0 },
                                        ...
                                        if (u && c) {
                                            ...
                                            f &&
                                                (!n && t.state.focused ? (e.collapse(u.node, u.offset), f.collapsed || (e.removeAllRanges(), e.addRange(f))) : (e.removeAllRanges(), e.addRange(f)),
                            ...
                            (Ua.prototype.pollContent = function () {
                                ...
                                var e,
                                    ...
                                    l = o.to();
                                if (
                                    (0 == a.ch && a.line > i.firstLine() && (a = it(a.line - 1, Ke(i.doc, a.line - 1).length)),
                                ...
                                if (1 == d.length && 1 == h.length && t == a.line) for (; f && f > a.ch && x.charCodeAt(x.length - p - 1) == y.charCodeAt(y.length - p - 1); ) f--, p++;
                        ...
                        (Ka.prototype.init = function (e) {
                            ...
                            function o(e) {
                                if (!xe(i, e)) {
                                    if (i.somethingSelected()) Ia({ lineWise: !1, text: i.getSelections() });
                                        ...
                                        if (!i.options.lineWiseCopyCut) return;
                                        var t = Pa(i);
                                        Ia({ lineWise: !0, text: t.text }), "cut" == e.type ? i.setSelections(t.ranges, null, $) : ((n.prevInput = ""), (r.value = t.text.join("\n")), z(r));
                                    }
                            ...
                            e.wrapper.insertBefore(this.wrapper, e.wrapper.firstChild),
                                ...
                                pe(r, "compositionstart", function () {
                                    ...
                                    n.composing && n.composing.range.clear(), (n.composing = { start: e, range: i.markText(e, i.getCursor("to"), { className: "CodeMirror-composing" }) });
                                }),
                            ...
                            (Ka.prototype.onContextMenu = function (e) {
                                ...
                                function v() {
                                    if (
                                        t.contextMenuPending == v &&
                                        ((t.contextMenuPending = !1), (t.wrapper.style.cssText = f), (r.style.cssText = d), a && l < 9 && i.scrollbars.setScrollTop((i.scroller.scrollTop = u)), null != r.selectionStart)
                                    ) {
                                        (!a || (a && l < 9)) && g();
                                        var e = 0,
                                            o = function () {
                                                i.selForContextMenu == n.doc.sel && 0 == r.selectionStart && r.selectionEnd > 0 && "​" == t.prevInput
                                                    ? ir(n, ho)(n)
                                                    : e++ < 10
                                ...
                                (e.prototype = {
                                    ...
                                    addOverlay: rr(function (t, n) {
                                        ...
                                        !(function (e, t, n) {
                                            ...
                                            e.splice(i, 0, t);
                                        })(this.state.overlays, { mode: i, modeSpec: t, opaque: n && n.opaque, priority: (n && n.priority) || 0 }, function (e) {
                                            return e.priority;
                                        }),
                                            this.state.modeGen++,
                                            pi(this);
                                    ...
                                    lineAtHeight: function (e, t) {
                                        return (e = Xn(this, { top: e, left: 0 }, t || "page").top), et(this.doc, e + this.display.viewOffset);
                                    },
                                    heightAtLine: function (e, t, n) {
                                        ...
                                        return Vn(this, i, { top: 0, left: 0 }, t || "page", n || r).top + (r ? this.doc.height - Gt(i) : 0);
                                    },
                                    ...
                                    addWidget: function (e, t, n, i, r) {
                                        ...
                                        (t.style.top = u + "px"),
                                            ...
                                            "right" == r
                                                ...
                                                : ("left" == r ? (c = 0) : "middle" == r && (c = (s.sizer.clientWidth - t.offsetWidth) / 2), (t.style.left = c + "px")),
                                            n &&
                                                ((o = this),
                                                (a = { left: c, top: u, right: c + t.offsetWidth, bottom: u + t.offsetHeight }),
                                    ...
                                    toggleOverwrite: function (e) {
                                        (null != e && e == this.state.overwrite) ||
                                            ((this.state.overwrite = !this.state.overwrite) ? O(this.display.cursorDiv, "CodeMirror-overwrite") : A(this.display.cursorDiv, "CodeMirror-overwrite"),
                                    ...
                                    refresh: rr(function () {
                                        ...
                                        pi(this),
                                            ...
                                            fr(this.display),
                                            (null == e || Math.abs(e - ai(this.display)) > 0.5 || this.options.lineWrapping) && di(this),
                                            ve(this, "refresh", this);
                                    }),
                                    ...
                                    (n.save = i),
                                        ...
                                        (n.toTextArea = function () {
                                            (n.toTextArea = isNaN),
                                                ...
                                                (e.style.display = ""),
                                                e.form && (ge(e.form, "submit", i), t.leaveSubmitMethodAlone || "function" != typeof e.form.submit || (e.form.submit = r));
                                        });
                                }),
                            ...
                            function (t, n) {
                                ...
                                function y(i, r) {
                                    ...
                                    if (h && r.indentation <= b && (F = i.match(c)) && F[1].length <= 6)
                                        return (r.quote = 0), (r.header = F[1].length), (r.thisLine.header = !0), n.highlightFormatting && (r.formatting = "header"), (r.f = r.inline), C(r);
                                    ...
                                    return h && r.indentation <= b && (F = i.match(f, !0))
                                        ? ((r.quote = 0),
                                          ...
                                          (r.code = -1),
                                          C(r))
                                        : r.setext || (!((k && y) || r.quote || !1 !== r.list || r.code || S || p.test(i.string)) && (F = i.lookAhead(1)) && (F = F.match(d)))
                                        ? (r.setext ? ((r.header = r.setext), (r.setext = 0), i.skipToEnd(), n.highlightFormatting && (r.formatting = "header")) : ((r.header = "=" == F[0].charAt(0) ? 1 : 2), (r.setext = r.header)),
                                          (r.thisLine.header = !0),
                                          (r.f = r.inline),
                                          C(r))
                                        : S
                                ...
                                function b(t, n) {
                                    ...
                                    if (!r) {
                                        ...
                                        (("xml" == a.mode.name && null === a.state.tagStart && !a.state.context && a.state.tokenize.isInText) || (n.md_inside && t.current().indexOf(">") > -1)) &&
                                ...
                                function C(e) {
                                    ...
                                    if (
                                        ...
                                        e.quote && (t.push(o.quote), !n.maxBlockquoteDepth || n.maxBlockquoteDepth >= e.quote ? t.push(o.quote + "-" + e.quote) : t.push(o.quote + "-" + n.maxBlockquoteDepth)),
                                        !1 !== e.list)
                                    ) {
                                ...
                                function k(t, r) {
                                    ...
                                    if ("*" === l || "_" === l) {
                                        ...
                                        var A = t.peek() || " ",
                                            ...
                                            M = null;
                                        if (
                                            (D % 2 && (r.em || !E || ("*" !== l && L && !m.test(w)) ? r.em != l || !L || ("*" !== l && E && !m.test(A)) || (T = !1) : (T = !0)),
                                            D > 1 && (r.strong || !E || ("*" !== l && L && !m.test(w)) ? r.strong != l || !L || ("*" !== l && E && !m.test(A)) || (M = !1) : (M = !0)),
                                            null != M || null != T)
                                        )
                                            return (
                                                n.highlightFormatting && (r.formatting = null == T ? "strong" : null == M ? "em" : "strong em"),
                                                !0 === T && (r.em = l),
                                                !0 === M && (r.strong = l),
                                                (f = C(r)),
                                                !1 === T && (r.em = !1),
                                ...
                                function T(e, t) {
                                    return e.eatSpace()
                                        ? null
                                        : (e.match(/^[^\s]+/, !0), void 0 === e.peek() ? (t.linkTitle = !0) : e.match(/^(?:\s+(?:"(?:[^"\\]|\\.)+"|'(?:[^'\\]|\\.)+'|\((?:[^)\\]|\\.)+\)))?/, !0), (t.f = t.inline = k), o.linkHref + " url");
                                }
                                var M = {
                                    startState: function () {
                                        return {
                                    ...
                                    token: function (e, t) {
                                        if (((t.formatting = !1), e != t.thisLine.stream)) {
                                            ...
                                            if (((t.prevLine = t.thisLine), (t.thisLine = { stream: e }), (t.taskList = !1), (t.trailingSpace = 0), (t.trailingSpaceNewLine = !1), !t.localState && ((t.f = t.block), t.f != b))) {
                                    ...
                                    innerMode: function (e) {
                                        return e.block == b ? { state: e.htmlState, mode: i } : e.localState ? { state: e.localState, mode: e.localMode } : { state: e, mode: M };
                                    },
                        ...
                        e.defineMode("xml", function (i, r) {
                            ...
                            function D(e, t, n) {
                                if ("word" == e) {
                                    var i = t.current();
                                    return (
                                        n.context && n.context.tagName != i && s.implicitlyClosed.hasOwnProperty(m(n.context.tagName)) && v(n),
                                        (n.context && n.context.tagName == i) || !1 === s.matchClosing ? ((a = "tag"), C) : ((a = "tag error"), w)
                                    );
                                }
                ...
                function (e, t, n) {
                    !(function (e, i) {
                            ...
                            if (
                                ...
                                (i = (function (e, t) {
                                    if (e) {
                                        ...
                                        return (
                                            "Object" === i && e.constructor && (i = e.constructor.name), "Map" === i || "Set" === i ? Array.from(e) : "Arguments" === i || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(i) ? n(e, t) : void 0
                                        );
                                    }
                                })(e)) ||
                        ...
                        function L(e, t, n, i) {
                            ...
                            if ("!" !== e[0].charAt(0)) {
                                i.state.inLink = !0;
                                var l = { type: "link", raw: n, href: r, title: o, text: a, tokens: i.inlineTokens(a) };
                                ...
                                return (
                                    ...
                                    (n.code = function (e) {
                                        ...
                                        if (t) {
                                            ...
                                            return { type: "code", raw: t[0], codeBlockStyle: "indented", text: this.options.pedantic ? n : F(n, "\n") };
                                        }
                                    }),
                                    (n.fences = function (e) {
                                        ...
                                        if (t) {
                                            ...
                                            for (var x = new RegExp("^( {0,3}" + m + ")((?:[\t ][^\\n]*)?(?:\\n|$))"); e && ((p = !1), (t = x.exec(e))) && !this.rules.block.hr.test(e); ) {
                                                if (
                                                    ...
                                                    (c = t[2].split("\n", 1)[0]),
                                                    (d = e.split("\n", 1)[0]),
                                                    this.options.pedantic ? ((a = 2), (f = c.trimLeft())) : ((a = (a = t[2].search(/[^ ]/)) > 4 ? 1 : a), (f = c.slice(a)), (a += t[1].length)),
                                                    (s = !1),
                                                    !c && /^ *$/.test(d) && ((n += d + "\n"), (e = e.substring(d.length + 1)), (p = !0)),
                                                    !p)
                                                )
                                                    for (
                                                        var y = new RegExp("^ {0," + Math.min(3, a - 1) + "}(?:[*+-]|\\d{1,9}[.)])((?: [^\\n]*)?(?:\\n|$))"),
                                                ...
                                                v.loose || (u ? (v.loose = !0) : /\n *\n *$/.test(n) && (u = !0)),
                                                    this.options.gfm && (r = /^\[[ xX]\] /.exec(f)) && ((o = "[ ] " !== r[0]), (f = f.replace(/^\[[ xX]\] +/, ""))),
                                                    v.items.push({ type: "list_item", raw: n, task: !!r, checked: o, loose: !1, text: f }),
                                                    (v.raw += n);
                                            }
                                    ...
                                    (n.table = function (e) {
                                        ...
                                        if (t) {
                                            ...
                                            if (n.header.length === n.align.length) {
                                                ...
                                                for (l = n.rows.length, r = 0; r < l; r++) for (a = n.rows[r], o = 0; o < a.length; o++) a[o].tokens = this.lexer.inline(a[o].text);
                                                return n;
                                            }
                                        }
                                    }),
                                    ...
                                    (n.link = function (e) {
                                        ...
                                        if (t) {
                                            ...
                                            return (
                                                ...
                                                L(t, { href: a ? a.replace(this.rules.inline._escapes, "$1") : a, title: l ? l.replace(this.rules.inline._escapes, "$1") : l }, t[0], this.lexer)
                                            );
                                        }
                                    }),
                                                        ...
                                                        if (((a = o.length), i[3] || i[4])) s += a;
                                                            ...
                                                            if (!((s -= a) > 0)) {
                                                                if (((a = Math.min(a, a + s + u)), Math.min(l, a) % 2)) {
                                                                    ...
                                                                    return { type: "em", raw: e.slice(0, l + i.index + a + 1), text: d, tokens: this.lexer.inlineTokens(d) };
                                                                }
                                                                var h = e.slice(2, l + i.index + a - 1);
                                                                return { type: "strong", raw: e.slice(0, l + i.index + a + 1), text: h, tokens: this.lexer.inlineTokens(h) };
                                                            }
                                                        } else u += a;
                                            }
                                        }
                                    ...
                                    (n.codespan = function (e) {
                                        ...
                                        if (t) {
                                            var n = t[2].replace(/\n/g, " "),
                                                i = /[^ ]/.test(n),
                                                r = /^ /.test(n) && / $/.test(n);
                                            return i && r && (n = n.substring(1, n.length - 1)), (n = d(n, !0)), { type: "codespan", raw: t[0], text: n };
                                        }
                                    }),
                                    (n.br = function (e) {
                                    ...
                                    (n.autolink = function (e, t) {
                                        ...
                                        if (r)
                                            return (i = "@" === r[2] ? "mailto:" + (n = d(this.options.mangle ? t(r[1]) : r[1])) : (n = d(r[1]))), { type: "link", raw: r[0], text: n, href: i, tokens: [{ type: "text", raw: n, text: n }] };
                                    }),
                                    (n.url = function (e, t) {
                                        var n;
                                        if ((n = this.rules.inline.url.exec(e))) {
                                            ...
                                            return { type: "link", raw: n[0], text: i, href: r, tokens: [{ type: "text", raw: i, text: i }] };
                                        }
                                    }),
                                    (n.inlineText = function (e, t) {
                                        ...
                                        if (i)
                                            return (
                                                (n = this.lexer.state.inRawBlock ? (this.options.sanitize ? (this.options.sanitizer ? this.options.sanitizer(i[0]) : d(i[0])) : i[0]) : d(this.options.smartypants ? t(i[0]) : i[0])),
                        ...
                        function O(e) {
                            var t,
                                ...
                                i = "",
                                r = e.length;
                            for (t = 0; t < r; t++) (n = e.charCodeAt(t)), Math.random() > 0.5 && (n = "x" + n.toString(16)), (i += "&#" + n + ";");
                            return i;
                        }
                        (B._punctuation = "!\"#$%&'()+\\-.,/:;<=>?@\\[\\]`^{|}~"),
                        ...
                        var I = (function () {
                                function n(t) {
                                    ...
                                    this.options.pedantic ? ((n.block = M.pedantic), (n.inline = B.pedantic)) : this.options.gfm && ((n.block = M.gfm), this.options.breaks ? (n.inline = B.breaks) : (n.inline = B.gfm)),
                                ...
                                return (
                                            ...
                                            if (
                                                !(
                                                    ...
                                                    this.options.extensions.block.some(function (i) {
                                                        return !!(n = i.call({ lexer: a }, e, t)) && ((e = e.substring(n.raw.length)), t.push(n), !0);
                                                    })
                                                )
                                            )
                                                if ((n = this.tokenizer.space(e))) (e = e.substring(n.raw.length)), 1 === n.raw.length && t.length > 0 ? (t[t.length - 1].raw += "\n") : t.push(n);
                                                    ...
                                                    this.options.extensions &&
                                                        ...
                                                        (function () {
                                                            ...
                                                            a.options.extensions.startBlock.forEach(function (e) {
                                                                "number" == typeof (i = e.call({ lexer: this }, n)) && i >= 0 && (t = Math.min(t, i));
                                                            }),
                                                    ...
                                                    (e = e.substring(n.raw.length)),
                                                        (i = t[t.length - 1]) && "text" === i.type
                                                            ? ((i.raw += "\n" + n.raw), (i.text += "\n" + n.text), this.inlineQueue.pop(), (this.inlineQueue[this.inlineQueue.length - 1].src = i.text))
                                                            : t.push(n);
                                                else if (e) {
                                    ...
                                    (a.inline = function (e, t) {
                                        return void 0 === t && (t = []), this.inlineQueue.push({ src: e, tokens: t }), t;
                                    }),
                                            ...
                                            if (
                                                ...
                                                !(
                                                    ...
                                                    this.options.extensions.inline.some(function (i) {
                                                        return !!(n = i.call({ lexer: o }, e, t)) && ((e = e.substring(n.raw.length)), t.push(n), !0);
                                                    })
                                                ))
                                            )
                                                if ((n = this.tokenizer.escape(e))) (e = e.substring(n.raw.length)), t.push(n);
                                                    ...
                                                    if (
                                                        ...
                                                        (e = e.substring(n.raw.length)),
                                                            ...
                                                            (l = !0),
                                                            (i = t[t.length - 1]) && "text" === i.type ? ((i.raw += n.raw), (i.text += n.text)) : t.push(n);
                                                    else if (e) {
                                ...
                                return (
                                        ...
                                        for (n = 0; n < w; n++)
                                            if (
                                                ...
                                                !(this.options.extensions && this.options.extensions.renderers && this.options.extensions.renderers[d.type]) ||
                                                    (!1 === (D = this.options.extensions.renderers[d.type].call({ parser: this }, d)) &&
                                                ...
                                                switch (d.type) {
                                                    ...
                                                    case "code":
                                                        ...
                                                        continue;
                                                    case "table":
                                                        for (u = "", s = "", o = d.header.length, i = 0; i < o; i++) s += this.renderer.tablecell(this.parseInline(d.header[i].tokens), { header: !0, align: d.align[i] });
                                                        for (u += this.renderer.tablerow(s), c = "", o = d.rows.length, i = 0; i < o; i++) {
                                                            for (s = "", a = (l = d.rows[i]).length, r = 0; r < a; r++) s += this.renderer.tablecell(this.parseInline(l[r].tokens), { header: !1, align: d.align[r] });
                                                    ...
                                                    case "blockquote":
                                                        ...
                                                        continue;
                                                    case "list":
                                                        for (h = d.ordered, p = d.start, m = d.loose, o = d.items.length, c = "", i = 0; i < o; i++)
                                                                        ...
                                                                        ? v.tokens.length > 0 && "paragraph" === v.tokens[0].type
                                                                            ? ((v.tokens[0].text = b + " " + v.tokens[0].text),
                                                                              v.tokens[0].tokens &&
                                                                                  ...
                                                                                  (v.tokens[0].tokens[0].text = b + " " + v.tokens[0].tokens[0].text))
                                    ...
                                    (n.parseInline = function (e, t) {
                                        ...
                                        for (n = 0; n < a; n++)
                                            if (
                                                ((i = e[n]),
                                                !(this.options.extensions && this.options.extensions.renderers && this.options.extensions.renderers[i.type]) ||
                                                    (!1 === (r = this.options.extensions.renderers[i.type].call({ parser: this }, i)) && ["escape", "html", "link", "image", "strong", "em", "codespan", "br", "del", "text"].includes(i.type)))
                                            )
                                                switch (i.type) {
                                                    case "escape":
                                                    case "text":
                                                    ...
                                                    o[e.level] ? o[e.level].unshift(e.tokenizer) : (o[e.level] = [e.tokenizer]),
                                                        e.start &&
                                                            ("block" === e.level
                                                                ...
                                                                : "inline" === e.level && (o.startInline ? o.startInline.push(e.start) : (o.startInline = [e.start])));
                                                }
                                        ...
                                        o = function () {
                                            ...
                                            switch (((r = r.concat(t.call(_, e))), e.type)) {
                                                ...
                                                case "list":
                                                    ...
                                                    break;
                                                default:
                                                    _.defaults.extensions && _.defaults.extensions.childTokens && _.defaults.extensions.childTokens[e.type]
                            ...
                            !(function () {
                                ...
                                (i = function (e, t, i, r) {
                                    ...
                                    function p() {
                                        ...
                                        for (a in ("ONLYINCOMPOUND" in c.flags && (c.compoundRuleCodes[c.flags.ONLYINCOMPOUND] = []), (c.dictionaryTable = c._parseDIC(i)), c.compoundRuleCodes))
                                    ...
                                    return (
                                        e &&
                                            ...
                                            t && i
                                                ...
                                                : ((o = r.dictionaryPath ? r.dictionaryPath : void 0 !== n ? n + "/dictionaries" : "./dictionaries"), t || d(o + "/" + e + "/" + e + ".aff", h), i || d(o + "/" + e + "/" + e + ".dic", f))),
                                        this
                                    );
                                }).prototype = {
                                    load: function (e) {
                                    ...
                                    checkExact: function (e) {
                                        ...
                                        if (void 0 === i) {
                                            ...
                                            if (null === i) return !0;
                                            if ("object" == typeof i) for (t = 0, n = i.length; t < n; t++) if (!this.hasFlag(e, "ONLYINCOMPOUND", i[t])) return !0;
                                        }
                                        return !1;
                                    },
                                        ...
                                        function s(e, t) {
                                            ...
                                            for (var u in e)
                                                for (n = 0, r = u.length + 1; n < r; n++) {
                                                    ...
                                                    if (
                                                        (c[1] && ((o = c[0] + c[1].substring(1)), (t && !l.check(o)) || (o in a ? (a[o] += 1) : (a[o] = 1))),
                                                        c[1].length > 1 && c[1][1] !== c[1][0] && ((o = c[0] + c[1][1] + c[1][0] + c[1].substring(2)), (t && !l.check(o)) || (o in a ? (a[o] += 1) : (a[o] = 1))),
                                                        c[1])
                                                    ) {
                ...
                function (e, t, n) {
                    ...
                    function h(e, t, n, i) {
                        ...
                        for (var a = 0; a < e.children.length; a++) {
                            var l,
                                s = e.children[a];
                            (l = f("string" == typeof s && s in te ? te[s] : s, !0, t, n, "button", i)).addEventListener(
                                "click",
                                function (e) {
                                    e.stopPropagation();
                                },
                    ...
                    function f(e, t, n, i, r, o) {
                        ...
                        if (e.attributes) for (var u in e.attributes) Object.prototype.hasOwnProperty.call(e.attributes, u) && l.setAttribute(u, e.attributes[u]);
                        ...
                        (l.className = c + e.name),
                            ...
                            e.title &&
                                ...
                                a && ((l.title = l.title.replace("Ctrl", "⌘")), (l.title = l.title.replace("Alt", "⌥")))),
                    ...
                    function m(e, t) {
                        ...
                        for (var i, r, o = n.type.split(" "), a = {}, l = 0; l < o.length; l++)
                            "strong" === (i = o[l])
                                ? (a.bold = !0)
                                : "variable-2" === i
                                ? ((r = e.getLine(t.line)), /^\s*\d+\.\s/.test(r) ? (a["ordered-list"] = !0) : (a["unordered-list"] = !0))
                                : "atom" === i
                                ? (a.quote = !0)
                                : "em" === i
                                ? (a.italic = !0)
                                ...
                                ? "image" === i
                                    ? (a.image = !0)
                                    : i.match(/^header(-[1-6])?$/) && (a[i.replace("header", "heading")] = !0)
                                : (a.link = !0);
                        return a;
                    }
                    var g = "";
                    function v(e) {
                        ...
                        void 0 !== e.options.maxHeight &&
                            (t.getOption("fullScreen") ? (t.getScrollerElement().style.removeProperty("height"), i.style.removeProperty("height")) : ((t.getScrollerElement().style.height = e.options.maxHeight), e.setPreviewMaxHeight())),
                    ...
                    function D(e) {
                        ...
                        function r(e, t, r, o, a) {
                            (r = r || e.getLineHandle(t)), (o = o || e.getTokenAt({ line: t, ch: 1 })), (a = a || (!!r.text && e.getTokenAt({ line: t, ch: r.text.length - 1 })));
                        ...
                        if ("single" === f) {
                            ...
                            s.replaceRange(p + m, { line: u.line, ch: 0 }, { line: u.line, ch: 99999999999999 }), u.ch--, u !== c && c.ch--, s.setSelection(u, c), s.focus();
                        } else if ("fenced" === f)
                            if (u.line !== c.line || u.ch !== c.ch) {
                                ...
                                n(s.getLineHandle(u.line)) ? ((g = ""), (v = u.line)) : n(s.getLineHandle(u.line - 1)) ? ((g = ""), (v = u.line - 1)) : ((g = b + "\n"), (v = u.line)),
                                    n(s.getLineHandle(c.line)) ? ((x = ""), (y = c.line), 0 === c.ch && (y += 1)) : 0 !== c.ch && n(s.getLineHandle(c.line + 1)) ? ((x = ""), (y = c.line + 1)) : ((x = b + "\n"), (y = c.line + 1)),
                                    0 === c.ch && (y -= 1),
                                    s.operation(function () {
                                        s.replaceRange(x, { line: y, ch: 0 }, { line: y + (x ? 0 : 1), ch: 0 }), s.replaceRange(g, { line: v, ch: 0 }, { line: v + (g ? 0 : 1), ch: 0 });
                                    }),
                                    s.setSelection({ line: v + (g ? 1 : 0), ch: 0 }, { line: y + (g ? 1 : -1), ch: 0 }),
                                    s.focus();
                            } else {
                                var D = u.line;
                                ...
                                s.operation(function () {
                                    s.replaceRange("", { line: o, ch: 0 }, { line: o + 1, ch: 0 }), s.replaceRange("", { line: a - 1, ch: 0 }, { line: a, ch: 0 });
                                }),
                                    s.focus();
                            }
                        else if ("indented" === f) {
                            ...
                            S || F
                                ? (function (e, t, n, i) {
                                      var r = t.line + 1,
                                          ...
                                          l = i + "\n",
                                          s = "\n" + i;
                                      a && o++, a && 0 === n.ch && ((s = i + "\n"), o--), $(e, !1, [l, s]), e.setSelection({ line: r, ch: 0 }, { line: o, ch: 0 });
                                  })(s, u, c, t)
                                : $(s, !1, ["`", "`"]);
                        }
                    }
                    ...
                    function N(e) {
                        !(function (e) {
                            ...
                            for (var t, n = e.getCursor("start"), i = e.getCursor("end"), r = n.line; r <= i.line; r++)
                                (t = (t = e.getLine(r)).replace(/^[ ]*([# ]+|\*|-|[> ]+|[0-9]+(.|\)))[ ]*/, "")), e.replaceRange(t, { line: r, ch: 0 }, { line: r, ch: 99999999999999 });
                        })(e.codemirror);
                    }
                    function O(e) {
                        var t = e.options,
                    ...
                    function q(e) {
                        ...
                        i.classList.contains("editor-preview-active-side")
                            ? (!1 === e.options.sideBySideFullscreen && a.classList.remove("sided--no-fullscreen"), i.classList.remove("editor-preview-active-side"), r && r.classList.remove("active"), n.classList.remove("CodeMirror-sided"))
                            : (setTimeout(function () {
                    ...
                    function U(e) {
                        ...
                        if ((t.getWrapperElement().nextSibling.classList.contains("editor-preview-active-side") && q(e), !o || !o.classList.contains("editor-preview-full"))) {
                            if ((((o = document.createElement("div")).className = "editor-preview-full"), e.options.previewClass))
                                if (Array.isArray(e.options.previewClass)) for (var a = 0; a < e.options.previewClass.length; a++) o.classList.add(e.options.previewClass[a]);
                        ...
                        o.classList.contains("editor-preview-active")
                            ? (o.classList.remove("editor-preview-active"), r && (r.classList.remove("active"), i.classList.remove("disabled-for-preview")))
                            : (setTimeout(function () {
                    ...
                    function $(e, t, n, i) {
                        if (!e.getWrapperElement().lastChild.classList.contains("editor-preview-active")) {
                            ...
                            Object.assign(l, e.getCursor("start")),
                                ...
                                t
                                    ? ((o = (r = e.getLine(l.line)).slice(0, l.ch)), (a = r.slice(l.ch)), e.replaceRange(o + a, { line: l.line, ch: 0 }))
                                    : ((r = e.getSelection()), e.replaceSelection(o + r + a), (l.ch += o.length), l !== s && (s.ch += o.length)),
                                e.setSelection(l, s),
                                e.focus();
                        }
                    }
                            ...
                            for (
                                var i = /^(\s*)(\*|-|\+|\d*\.)(\s+)/,
                                    ...
                                    u = function (e, t, o) {
                                        var a = i.exec(t),
                                            l = (function (e, t) {
                                                return { quote: ">", "unordered-list": n, "ordered-list": "%%i." }[e].replace("%%i", t);
                                            })(e, c);
                                        return (
                                            null !== a
                                                ? ((function (e, t) {
                                                      var i = new RegExp({ quote: ">", "unordered-list": "\\" + n, "ordered-list": "\\d+." }[e]);
                                                      return t && i.test(t);
                                                  })(e, a[2]) && (l = ""),
                                ...
                                !(function (n) {
                                    var i = e.getLine(n);
                                    o[t] ? (i = i.replace(s[t], "$1")) : ("unordered-list" == t && (i = u("ordered-list", i, !0)), (i = u(t, i, !1)), (c += 1)), e.replaceRange(i, { line: n, ch: 0 }, { line: n, ch: 99999999999999 });
                                })(d);
                            e.focus();
                        }
                    }
                        ...
                        if (e.codemirror && !e.isPreviewActive()) {
                            ...
                            if (o) {
                                ...
                                "link" == t ? (u = u.replace(/(.*)[^!]\[/, "$1")) : "image" == t && (u = u.replace(/(.*)!\[$/, "$1")),
                                    (c = c.replace(/]\(.*?\)/, "")),
                                    r.replaceRange(u + c, { line: a.line, ch: 0 }, { line: a.line, ch: 99999999999999 }),
                                    (a.ch -= n[0].length),
                                    a !== l && (l.ch -= n[0].length),
                                    r.setSelection(a, l),
                                    r.focus();
                        ...
                        if (e.codemirror && !e.isPreviewActive()) {
                            ...
                            a[t]
                                ? ((l = (r = o.getLine(u.line)).slice(0, u.ch)),
                                  (s = r.slice(u.ch)),
                                  "bold" == t
                                      ? ((l = l.replace(/(\*\*|__)(?![\s\S]*(\*\*|__))/, "")), (s = s.replace(/(\*\*|__)/, "")))
                                      : "italic" == t
                                      ? ((l = l.replace(/(\*|_)(?![\s\S]*(\*|_))/, "")), (s = s.replace(/(\*|_)/, "")))
                                      : "strikethrough" == t && ((l = l.replace(/(\*\*|~~)(?![\s\S]*(\*\*|~~))/, "")), (s = s.replace(/(\*\*|~~)/, ""))),
                                  o.replaceRange(l + s, { line: u.line, ch: 0 }, { line: u.line, ch: 99999999999999 }),
                                  "bold" == t || "strikethrough" == t ? ((u.ch -= 2), u !== c && (c.ch -= 2)) : "italic" == t && ((u.ch -= 1), u !== c && (c.ch -= 1)))
                                : ((r = o.getSelection()),
                    ...
                    function Y(e, t) {
                        for (var n in t)
                            Object.prototype.hasOwnProperty.call(t, n) &&
                                (t[n] instanceof Array ? (e[n] = t[n].concat(e[n] instanceof Array ? e[n] : [])) : null !== t[n] && "object" == typeof t[n] && t[n].constructor === Object ? (e[n] = Y(e[n] || {}, t[n])) : (e[n] = t[n]));
                        return e;
                    }
                    function Q(e) {
                    ...
                    var ee = {
                        ...
                        te = {
                            ...
                            italic: { name: "italic", action: y, className: ee.italic, title: "Italic", default: !0 },
                            strikethrough: { name: "strikethrough", action: b, className: ee.strikethrough, title: "Strikethrough" },
                            heading: { name: "heading", action: w, className: ee.heading, title: "Heading", default: !0 },
                            "heading-smaller": { name: "heading-smaller", action: w, className: ee["heading-smaller"], title: "Smaller Heading" },
                            "heading-bigger": { name: "heading-bigger", action: k, className: ee["heading-bigger"], title: "Bigger Heading" },
                            "heading-1": { name: "heading-1", action: S, className: ee["heading-1"], title: "Big Heading" },
                            "heading-2": { name: "heading-2", action: F, className: ee["heading-2"], title: "Medium Heading" },
                            "heading-3": { name: "heading-3", action: A, className: ee["heading-3"], title: "Small Heading" },
                            ...
                            "unordered-list": { name: "unordered-list", action: M, className: ee["unordered-list"], title: "Generic List", default: !0 },
                            "ordered-list": { name: "ordered-list", action: B, className: ee["ordered-list"], title: "Numbered List", default: !0 },
                            "clean-block": { name: "clean-block", action: N, className: ee["clean-block"], title: "Clean block" },
                            "separator-2": { name: "separator-2" },
                            link: { name: "link", action: O, className: ee.link, title: "Create Link", default: !0 },
                            image: { name: "image", action: I, className: ee.image, title: "Insert Image", default: !0 },
                            "upload-image": { name: "upload-image", action: H, className: ee["upload-image"], title: "Import an image" },
                            ...
                            preview: { name: "preview", action: U, className: ee.preview, noDisable: !0, title: "Toggle Preview", default: !0 },
                            "side-by-side": { name: "side-by-side", action: q, className: ee["side-by-side"], noDisable: !0, noMobile: !0, title: "Toggle Side by Side", default: !0 },
                            fullscreen: { name: "fullscreen", action: v, className: ee.fullscreen, noDisable: !0, noMobile: !0, title: "Toggle Fullscreen", default: !0 },
                            "separator-4": { name: "separator-4" },
                            guide: { name: "guide", action: "https://www.markdownguide.org/basic-syntax/", className: ee.guide, noDisable: !0, title: "Markdown Guide", default: !0 },
                        ...
                        if (void 0 === e.toolbar)
                            for (var o in ((e.toolbar = []), te))
                                Object.prototype.hasOwnProperty.call(te, o) &&
                                    (-1 != o.indexOf("separator-") && e.toolbar.push("|"), (!0 === te[o].default || (e.showIcons && e.showIcons.constructor === Array && -1 != e.showIcons.indexOf(o))) && e.toolbar.push(o));
                        if (
                            (Object.prototype.hasOwnProperty.call(e, "previewClass") || (e.previewClass = "editor-preview"),
                            Object.prototype.hasOwnProperty.call(e, "status") || ((e.status = ["autosave", "lines", "words", "cursor"]), e.uploadImage && e.status.unshift("upload-image")),
                            e.previewRender ||
                    ...
                    (se.prototype.uploadImages = function (e, t, n) {
                        ...
                        (se.prototype.markdown = function (e) {
                            if (o) {
                                var t;
                                if (
                                    ((t = this.options && this.options.renderingConfig && this.options.renderingConfig.markedOptions ? this.options.renderingConfig.markedOptions : {}),
                                ...
                                var i = o.parse(e);
                                return (
                                    this.options.renderingConfig && "function" == typeof this.options.renderingConfig.sanitizerFunction && (i = this.options.renderingConfig.sanitizerFunction.call(this, i)),
                                    (i = (function (e) {
                        ...
                        (se.prototype.render = function (e) {
                            if ((e || (e = this.element || document.getElementsByTagName("textarea")[0]), !this._rendered || this._rendered !== e)) {
                                ...
                                if (
                                    ...
                                    !1 !== o.spellChecker &&
                                        ((t = "spell-checker"), ((n = o.parsingConfig).name = "gfm"), (n.gitHubSpice = !1), "function" == typeof o.spellChecker ? o.spellChecker({ codeMirrorInstance: i }) : r({ codeMirrorInstance: i })),
                                            ...
                                            if (t.innerText.match(/^!\[.*?\]\(.*\)/g) && !t.hasAttribute("data-img-src")) {
                                                ...
                                                if ((window.EMDEimagesCache || (window.EMDEimagesCache = {}), n && n.length >= 2)) {
                                                    ...
                                                    if (window.EMDEimagesCache[i]) x(t, window.EMDEimagesCache[i]);
                                                        ...
                                                        (a.onload = function () {
                                                            (window.EMDEimagesCache[i] = { naturalWidth: a.naturalWidth, naturalHeight: a.naturalHeight, url: i }), x(t, window.EMDEimagesCache[i]);
                                                        }),
                                                            (a.src = i);
                                                    }
                                                }
                                ...
                                e.setAttribute("data-img-src", t.url),
                                    e.setAttribute(
                                        ...
                                        "--bg-image:url(" +
                                            ...
                                            t.naturalWidth +
                                            "px;--height:" +
                                            ((n = t.naturalWidth), (i = t.naturalHeight), n < window.getComputedStyle(document.querySelector(".CodeMirror-sizer")).width.replace("px", "") ? i + "px" : (i / n) * 100 + "%")
                                    ),
                                ...
                                (l.upload.onprogress = function (t) {
                                    ...
                                    (l.onload = function () {
                                        ...
                                        200 === this.status && e && !e.error && e.data && e.data.filePath
                                            ...
                                            : e.error
                                            ? r(o(e.error))
                                            : (console.error("EasyMDE: Received an unexpected response after uploading the image." + this.status + " (" + this.statusText + ")"), r(o(i.options.errorMessages.importError)));
                                    }),
                        ...
                        (se.prototype.createSideBySide = function () {
                            ...
                            if (!n || !n.classList.contains("editor-preview-side")) {
                                if ((((n = document.createElement("div")).className = "editor-preview-side"), this.options.previewClass))
                                    if (Array.isArray(this.options.previewClass)) for (var i = 0; i < this.options.previewClass.length; i++) n.classList.add(this.options.previewClass[i]);
                            ...
                            if ((e = e || this.options.toolbar) && 0 !== e.length) {
                                ...
                                for (i.toolbar = e, t = 0; t < e.length; t++)
                                    if (
                                        ...
                                        !((i.options.hideIcons && -1 != i.options.hideIcons.indexOf(e[t].name)) || (("fullscreen" == e[t].name || "side-by-side" == e[t].name) && c()))
                                    ) {
                                        if ("|" === e[t]) {
                                        ...
                                        !(function (e) {
                                            var t;
                                            if (
                                                ((t = "|" === e ? p() : e.children ? h(e, i.options.toolbarTips, i.options.shortcuts, i) : f(e, !0, i.options.toolbarTips, i.options.shortcuts, "button", i)),
                                                (r[e.name || e] = t),
                                                n.appendChild(t),
                                                "upload-image" === e.name)
                                            ) {
                        ...
                        (se.prototype.toTextArea = function () {
                            var e = this.codemirror,
                                t = e.getWrapperElement(),
                                n = t.parentNode;
                            n && (this.gui.toolbar && n.removeChild(this.gui.toolbar), this.gui.statusbar && n.removeChild(this.gui.statusbar), this.gui.sideBySide && n.removeChild(this.gui.sideBySide)),
