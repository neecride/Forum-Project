...
<head>
    ...
    <title><?= !empty($match['target']) ? $match['target'] :''; ?>&nbsp;|&nbsp;<?= $GetParams->GetParam(0) ?></title>
    ...
    <!-- Css Styles -->
    <link rel="stylesheet" href="<?= WEBROOT ?>templates/<?= $GetParams->GetParam(3) ?>/css/bootstrap.min.css" type="text/css">
    ...
    <link rel="stylesheet" href="<?= WEBROOT ?>templates/<?= $GetParams->GetParam(3) ?>/css/style.css" type="text/css">
    <link rel="stylesheet" href="<?= WEBROOT ?>templates/<?= $GetParams->GetParam(3) ?>/css/jquery.mCustomScrollbar.css" type="text/css">
...
<body>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="header__nav">
                    <nav class="header__menu mobile-menu">
                        <ul>
                            <li class="<?= ($router->match()['target'] == 'home') ?'active':''; ?>">
                                <a href="<?= $router->generate('home') ?>"><i class="fas fa-home"></i>&nbsp;Home</a>
                            </li>
                            <li class="<?= ($router->match()['target'] == 'forum' || $router->match()['target'] == 'viewtopic' || $router->match()['target'] == 'viewforums') ?'active':''; ?>">
                        ...
                        <?php if(empty($_SESSION['auth'])){ ?>
                            ...
                            <?php }else{ ?>
                                ...
                                <?php } ?>
                                <li><a href="<?= $router->generate('account') ?>"><i class="fas fa-user-circle"></i>&nbsp;<?= $_SESSION['auth']->username ?></a></li>
                                <li><a href="<?= $router->generate('logout') ?>"><i class="fas fa-sign-out-alt"></i>&nbsp;Logout</a></li>
                            <?php } ?>
                        </ul>
                    </nav>
                </div>
            ...
            <div class="col-lg-4">
                <div class="header__right None">
                    ...
                    <?php }else{ ?>
                        <?php if(isset($_SESSION['auth']->authorization) && !empty($_SESSION['auth']->authorization >= 4)){ ?>
                            <a class="<?= ($router->match()['target'] == 'admin') ?'active':''; ?>" href="<?= $router->generate('admin') ?>">
                                <i class="fas fa-tachometer-alt"></i>&nbsp;administration
                            </a>
                            |
                        <?php } ?>
                ...
                <div class="col-lg-3">
                    <div class="footer__logo">
                        ...
                        <?php if (defined('DEBUG_TIME')): ?>
                            <p style="text-align: left;">Page généré en <?= round(1000 * (microtime(true) - DEBUG_TIME)) ?> ms</p>
                        <?php endif ?>
                    </div>
                </div>
                <div class="col-lg-6">
    ...
    <!-- Js Plugins -->
    <script type="text/javascript" src="<?= WEBROOT ?>templates/reup/js/jquery-3.3.1.min.js"></script>
    <script type="text/javascript" src="<?= WEBROOT ?>templates/reup/js/popper.min.js"></script>
    <script type="text/javascript" src="<?= WEBROOT ?>templates/reup/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="<?= WEBROOT ?>templates/reup/js/jquery.mCustomScrollbar.concat.min.js"></script>
    <script type="text/javascript" src="<?= WEBROOT ?>templates/reup/js/to-markdown.js"></script>
    <script type="text/javascript" src="<?= WEBROOT ?>templates/reup/js/markdown.js"></script>
    <script type="text/javascript" src="<?= WEBROOT ?>templates/reup/js/popover.js"></script>
    ...
    <script type="text/javascript" src="<?= WEBROOT ?>templates/reup/js/jquery.hotkeys.js"></script>
