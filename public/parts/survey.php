...
<?php include 'parts/top-account.php'; ?>
    ...
    <div class="col-md-12">
        ...
        <div class="anime__review__item__text">
            ...
            <div class="F_user_info col-md-2">
            <div class="flags">
    ...
    <div class="card mb-2  child">
        <div class="card-body">
            <h3>Vous n'avez pas de topic pour le moment</h3>
        </div>
    </div>
    <?php endif; ?>
    </div>
        ...
        <nav>
          <ul class="pagination mb-3 mt-3 pagination-sm">
              ...
              for($i=1; $i <= $pages; $i++){
                if($i <= $nb || $i > $pages - $nb ||  ($i > $CurrentPage-$nb && $i < $CurrentPage+$nb)){
                  if($i == $CurrentPage) {
                    ...
                    echo '<li class="page-item"><a class="page-link" href='.$router->generate('survey').'>'. $i .'</a></li>' ;
                  }else{
                    echo '<li class="page-item"><a class="page-link" href='.$router->generate('survey').'?page='.$i.'>'. $i .'</a></li>' ;
                  }
                }else{
            ...
            <?php if($CurrentPage < $pages): ?>
              <li class="page-item">
                <a class="page-link" href="<?= $router->generate('survey') ?>?page=<?= $CurrentPage+1 ?>">
