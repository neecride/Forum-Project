            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <a href="<?= $router->routeGenerate('remember') ?>" class="forget_pass">Mots de pass oublié ?</a>
                    </div>
                    <div class="col-md-6">
                        <div class="login__register">
                            <h3 class="text-center">Si vous n'avez pas de compte ?</h3>
                            <a href="<?= $router->routeGenerate('register') ?>" class="btn btn-danger w-100">Créer un compte</a>
                        </div>
                    </div>
                </div>
            </div>
