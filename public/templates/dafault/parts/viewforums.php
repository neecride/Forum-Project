<div class="row">
  <div class="col-lg-9 col-md-9">
      <div class="row">
        <div class="col-md-12">
          <div id="forum-tags" class="section-title">
            <h5>
              View forums tags
      ...
      <?php
        foreach ($viewforum->viewForumTags() as $posts):
          $rep = $viewforum->viewLastReponse($posts->topicid);
          $count = $viewforum->CountRep($posts->topicid);
      ?>
          ...
          <div class="anime__review__item__text">
            <div class="col-md-1">
              ...
              <div class="anime__review__item__pic">
                <?= $viewforum->renderAvatar($posts->avatar) ?>
                <?= $viewforum->hot($count->countid,20) ?>
                <?= $viewforum->isNew($posts->read_last, $posts->Lastdate) ?>
              </div>
            </div>
            <div class="F_corps col-md-6">
              <div>
                <span>
                  <a href="<?= $router->routeGenerate('viewtopic', ['id' => $posts->topicid]) ?>">
                    <?= ($posts->sticky == 1) ? '<i style="font-size:11px;" class="fas fa-thumbtack"></i>&nbsp;' : '' ; ?>
              ...
              <?php } else { //si on a une réponse ?>
                <div class="F_foot">
                  <a href="">
                  <?= $viewforum->renderAvatar($rep->avatar) ?>
            ...
            <div class="F_user_info col-md-3">
              <div class="flags">
                <?php foreach ($viewforum->Tags($posts->topicid) as $tags) : ?>
                  <div class="tags">
