...
<head>
    ...
    <!-- Css Styles -->
    <link rel="stylesheet" href="<?= $router->webroot() ?>templates/<?= $themeForLayout ?>/css/bootstrap.min.css" type="text/css">
    ...
    <link rel="stylesheet" href="<?= $router->webroot() ?>templates/<?= $themeForLayout ?>/css/style.css" type="text/css">
    <link rel="stylesheet" href="<?= $router->webroot() ?>templates/<?= $themeForLayout ?>/css/jquery.mCustomScrollbar.css" type="text/css">
...
<body>
    ...
    <section class="blog spad">
        ...
        <div class="container">  
                        ...
                        <div class="col-lg-12 text-center">
                            <div class="normal__breadcrumb__text">
                                <div class="header__logo">
                                    <h2><?= ucwords($GetParams->GetParam(1))  ?></h2>
                                </div>
                                <p><?= $GetParams->GetParam(0) ?></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <?php 
                ...
                if($activeWidget == "oui"): 
                    require_once RACINE.DS.'public'.DS.'templates'.DS.$themeForLayout.DS.'parts'.DS.'top'.DS.'widgetAlert.php'; 
                endif; 
            ?>
            <!-- Header End -->
            <?= Flash(); ?>
    ...
    <!-- Js Plugins -->
    <script type="text/javascript" src="<?= $router->webroot() ?>templates/<?= $themeForLayout ?>/js/jquery-3.3.1.min.js"></script>
    <script type="text/javascript" src="<?= $router->webroot() ?>templates/<?= $themeForLayout ?>/js/popper.min.js"></script>
    <script type="text/javascript" src="<?= $router->webroot() ?>templates/<?= $themeForLayout ?>/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="<?= $router->webroot() ?>templates/<?= $themeForLayout ?>/js/to-markdown.js"></script>
    <script type="text/javascript" src="<?= $router->webroot() ?>templates/<?= $themeForLayout ?>/js/markdown.js"></script>
    <script type="text/javascript" src="<?= $router->webroot() ?>templates/<?= $themeForLayout ?>/js/popover.js"></script>
